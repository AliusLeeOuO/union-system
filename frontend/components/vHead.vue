<template>
  <header class="header-pc">
    <div class="header-left">
      <nuxt-link to="/" custom v-slot="{ navigate }">
        <div @click="navigate" class="logo">{{ title }}</div>
      </nuxt-link>
    </div>
    <nav>
      <nuxt-link :to="item.path" v-for="item in navList" :key="item.title"
                 class="nav-item">
        <div>
          {{ item.title }}
        </div>
  ...
  <header class="header-mobile">
    ...
    <div class="mobile-nav" :class="{'open-mobile-nav': openMobileNav}">
      ...
      <div class="mobile-nav-main">
        <nuxt-link :to="item.path" v-for="item in navList" :key="item.title" @click="openMobileNav = false"
