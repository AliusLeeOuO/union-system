...
type Permission struct {
	...
	ParentPermissionID uint      `gorm:"column:parent_permission_id" json:"parent_permission_id"`
	...
	ListHidden         bool      `gorm:"column:list_hidden" json:"list_hidden"`
	ListOrder          uint      `gorm:"column:list_order" json:"list_order"`
	ForType            string    `gorm:"column:for_type;size:10" json:"for_type"`
}
